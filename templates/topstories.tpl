<table class="table table-striped col-xs-12 col-md-12">
    ...
    <thead class="blockhead">
        <tr>
            ...
            <th class="col-xs-1 col-md-1 text-left"></th>
            <th class="col-xs-1 col-md-2 text-left"><i class="fa fa-calendar"></i><span class="hidden-xs"> Pub Date</span></th>
...
{if $story.pubdate}
            ...
            <td class="text-right text-muted hint" title="Published {$story.pubdate|date_format:"%A, %B %e, %Y"} at {$story.pubdate|date_format:"%l:%M %p, %Z"}"><span class="visible-xs-inline">{$story.pubdate|date_format:"%a"}</span><span style='color:silver; padding-left:2em'>{$story.pubdate|ago} ago</span></span></td>
{else}
